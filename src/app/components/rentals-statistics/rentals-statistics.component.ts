...
//     let chartRevenuesRentals = new RevenuesRentals(this.serviceLogic, this.rentalsdata);
//     let pstdata = [] as any;
...
//   color = new Colors();
//   rentalsdata: any;
//   constructor(private serviceLogic: ServiceLogicService, rentalsdata: any) { 
//     this.rentalsdata = rentalsdata
//   }

//   getRentalsLabels() {
//     let rentals = this.rentalsdata
//     let labelsrentals = [];
//     if (rentals != null) {
