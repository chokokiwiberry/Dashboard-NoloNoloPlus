...
export class InventoryStatisticsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('sono input', this.listings);
    console.log('sono input e sono rentals', this.rentals);
    this.serviceLogic.LoadingRentals();
    this.asyncPostCall(this.rentals)
  ...
  asyncPostCall = async (rentals: any) => {
    ...
    let chartCategoryN = new CategoryProds(this.listings, this.rentals);
    let chartProds = new Prods(this.listings, this.rentals);
